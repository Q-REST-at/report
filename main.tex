...
% TODO: we may consider commenting this out for now.
...
% =*= HYPOTHESES =*=
%   TODO: Ask Francisco about Hypothesis
%
...
\begin{RQBox}
    \begin{itemize}
    % 2-tail T-test (sort of)
    % FIXME: this may not work, because Wilcowon doesn't infer directionality
